...
### توكنك هنا
TOKEN = '7230891360:AAEXH0U4zfbphga3jqUTSUzO0LMpT7NSw88'
### id الادمن هنا
YOUR_ADMIN_ID ='5973960093'
...
def get_start_markup(user_id):
    ...
    markup.add(InlineKeyboardButton(" قناه المطور ⚙️", url="https://t.me/M1telegramM1"))
    markup.add(InlineKeyboardButton("مطور البوت 💻", url="https://t.me/M3_mo2"))
...
def welcome_message(message):
    ...
    bot.send_message(message.chat.id, 
                     f"اهلا بيك 👋 {username} في بوت متجر دارك ⚡️\n\n"
